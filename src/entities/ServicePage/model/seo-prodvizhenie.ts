  ...
  pricing: [
    {
      ...
      description: 'Базовое SEO-продвижение: технический аудит, семантика, оптимизация.',
      features: [
        'Технический аудит',
        'Семантическое ядро до 100 запросов',
    ...
    },
    {
      ...
      description: 'SEO-продвижение плюс GEO-оптимизация под AI-поисковики.',
      features: [
        'Всё из тарифа «Старт»',
        'GEO-оптимизация контента',
        'Настройка llms.txt и Schema',
        'Ссылочное продвижение',
        'Контент-стратегия',
    ...
    },
    {
      ...
      description: 'E-commerce, порталы, мультирегиональное продвижение — обсудим.',
      features: [
        'Полный SEO и GEO аудит',
